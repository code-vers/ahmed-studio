...
export default function UserManagementTable({ users }: any) {
	...
	return (
		<>
			<h2 className="text-3xl font-normal pb-2">User Management</h2>
			<div className="bg-white rounded-lg border border-[#caa57b] p-6">
				<Table>
					{/* Header */}
					<TableHeader>
						<TableRow className="py-2 ">
							<TableHead className="w-[35%]">User Management</TableHead>
					...
					<TableBody>
						{users.map((user: any) => (
							<TableRow key={user.id} className="border-0 py-2">
								{/* User */}
								<TableCell>
